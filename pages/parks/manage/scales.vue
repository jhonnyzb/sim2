...
export default {
  ...
  nuxtI18n: {
    paths: {
      en: '/parks/manage/scales',
      es: '/parques/administrar/escalas',
    },
  },
  components: {
  ...
  meta: {
    ...
    permissions(bouncer, to, from) {
      ...
      const abilities = service.manageAbilities(service.models.SCALE)
  ...
  computed: {
    title() {
      return this.$t('parks.park.scale')
    },
    canCreateAction() {
      return this.canManageOrCreate(this.ability_service.models.SCALE)
    },
    canUpdateAction() {
      return this.canManageOrUpdate(this.ability_service.models.SCALE)
    },
    canDeleteAction() {
      return this.canManageOrDestroy(this.ability_service.models.SCALE)
    },
    canViewHiAction() {
      return this.canViewHistory(this.ability_service.models.SCALE)
    },
  },
  methods: {
    subtextFormat(str) {
